...
if (connection == 'open') {
console.log(chalk.yellow('▣──────────────────────────────···\n│\n│❧ CORRECTLY CONNECTED TO WHATSAPP ✅\n│\n▣──────────────────────────────···'))}
}
...
conn.sDesc = '*group description has been modified*\n\n*new description:* @desc'
conn.sSubject = '*group has been renamed*\n*new name:* @subject'
conn.sIcon = '*group photo changed!!*'
conn.sRevoke = '*group link updated!!*\n*new link:* @revoke'
