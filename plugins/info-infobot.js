...
const { restrict, antiCall, antiprivate } = global.db.data.settings[conn.user.jid] || {}
...
╠═〘 BOT INFO 〙 ═
╠
╠➥ [🤴🏻] CREATOR: *Bruno Nephew*
╠➥ [#️] NUMBER: *+52 1 999 209 5479*
╠➥ [🎳] PREFIX: *${usedPrefix}*
...
╠➥ [☑️] AUTOREAD: ${autoread ? '*enabled': 'disabled*'}
╠➥ [!] RESTRICT: ${restrict ? '*enabled' :'disabled*'}
╠➥ [💬] ANTIPRIVATE: ${antiprivate ? '*enabled': 'disabled*'}
╠➥ [📵] ANTICALL: ${antiCall ? '*enabled' :'disabled*'}
╠➥ [💬] PCONLY: ${pconly ? '*enabled' :'disabled*'}
╠➥ [🏢] GCONLY: ${gconly ? '*enabled' :'disabled*'}
