let handler = async (m, { conn }) => {
  ...
  "Have you ever liked someone? How long?",
    "If possible or if you want, in gc / out of gc, who will you make friends with? (Can be different / same type)",
    ...
    "Who is the closest to your ideal match type here?",
    ...
    "What's your worst habit at school?", "What TV show do you hate the most? You're right!", "What is the ugliest dress (in your opinion) you've ever worn and when did you wear it? "," What is the worst (gossip) you have said about your friend?","What is the most embarrassing thing about you?"," What is the first thing you see when you look at another person (of the opposite sex) ?",
  "What's the first thing that comes to mind when you look in the mirror?","What's the dumbest thing you've ever done?","What's the worst dream you've ever had?"," What is the craziest dream you can remember so far?",
  ...
  "What would you do if your boyfriend told you you had a bad nose or fingers?",
  "What do you think about before sleeping? eg: fantasizing about a partner, etc.",
  "? What do you think he stands out the most from you?", "? What part of your friend's body do you like the most and would you like to have?",
  "Which part of your body do you hate the most?", "Of all the classes in the school, which class would you like to enter and which class would you like to avoid?",
  "Describe your closest friend!"," Describe yourself in one word!","What movies and songs have made you cry?",
  "What is something that you have kept secret until now and nobody has discovered it?",
  "What is the most romantic thing someone (of the opposite sex) has done or given to you?",
  ...
  "If you were asked to undergo plastic surgery using a sample of your classmate's face, who would you emulate?",
  ...
  "Who do you want to exchange with for a day? (closest friends you both know) and why",
  ...
  "What date do you remember the most and like?",
  ...
  "What's the most ridiculous reason you've broken up with someone?",
  "What is the worst habit you have?",
  "What do you think is your best characteristic? And what is the worst?",
  "What's the bravest thing you've ever done?",
  "When was the last time you wet the bed?",
  "What do you dream of most about sleeping?",
  ...
  "What do you want to do with me... (x person), if later you can erase his memory (him,...)?",
  ...
  "What part of the body makes you more?",
  ...
  "Which mouth do you like more of the group here?",
