let handler = async (m, { conn }) => {
  ...
  "Drink whatever drink is near you, then mix it with chili and drink!",
  ...
  "Walking clapping and singing the song 'Happy Birthday' from the class to the hallway.",
  "Get down on one knee and say 'Marry me?' the first person to enter the room.",
  "Make an absurd headdress with fabric, whatever it is, keep asking for poses in front of the camera, keep climbing",
  "Say 'YOU'RE BEAUTIFUL / VERY BEAUTIFUL, DON'T LIE' to the girl you think is the prettiest in this class.",
  "Tell someone in class, 'First they told me she was your twin, we broke up, and then I had plastic surgery. And this is the most serious thing I've ever said.'",
  "Throwing someone's notebook in the trash, right in front of her eyes, saying 'This book no one can understand'",
  ...
  " Sit back in the middle of the basketball court while pretending it's a sunbathing beach.",
  ...
  "Eat food that has been mixed and will taste strange, but make sure the food is not harmful to health in the long or short term.",
  ...
  "Speaking of the person you like, your closest friends, the opposite sex you don't know at all and things like that.",
  ...
  "Ask for the signature of one of YOUR FREINDS",
  ...
  "Sing your favorite Disney movie away from home while you scream.",
  "Name from 1 blue to 20 blues quickly and you must not make any mistakes. If it is wrong, it must be repeated from the beginning.",
  "Put on a crown of copy paper and say 'HONOR THE KING' to everyone in the room as you mark each person with a ruler.",
  ...
  "Send the emoji '🦄💨' every time you write in a group 1 day",
  ...
  "Speak to your ex on WhatsApp and say 'I love you, please come back'. Send a screenshot as evidence of the challenge fulfilled!",
] 
