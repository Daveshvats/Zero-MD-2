...
let speed = `${neww - old}`
let doxing = `*[ ✔ ] PERSON SUCCESSFULLY DOXXED*\n*⏳ DOXXED IN: ${speed} seconds!*
...
*TCP OPEN PORTS:* 443
*SELLING ROUTER:* ERICCSON
*VENDING DEVICE:* WIN32-X
...
*MODEM JUMPS:* 64`
m.reply(doxing, null, { mentions: conn.parseMention(doxing) })
}
handler.help = ['doxear <name> | <@tag>']
handler.tags = ['fun']
